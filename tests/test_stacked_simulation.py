...
class TestStackedSimulation:
    ...
    def test_simulate_single_spending_level(self):
        ...
        scenarios = [
            ...
            create_scenario_config("Annuity", 50_000, has_annuity=True,
                                 annuity_type="Fixed Period",
    ...
    def test_simulate_multiple_spending_levels(self):
        ...
        scenarios = [
            create_scenario_config("Test", 100_000, has_annuity=False)
        ]
    ...
    def test_stacking_efficiency(self):
        ...
        scenarios = [
            create_scenario_config(f"Scenario{i}", 100_000) 
            for i in range(4)
        ]
    ...
    def test_spending_axis_functionality(self):
        ...
        scenarios = [
            create_scenario_config("Stocks", 100_000)
        ]
    ...
    def test_mortality_handling(self):
        ...
        scenarios = [
            create_scenario_config("Test", 100_000)
        ]
