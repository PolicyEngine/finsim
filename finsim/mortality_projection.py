...
class MortalityProjector:
    ...
    def get_projected_mortality_rate(
        self, current_age: int, gender: str, projection_year: int
    ) -> float:
    ...
    def get_life_expectancy(
        self, current_age: int, gender: str, start_year: int = 2025, max_age: int = 120
    ) -> float:
...
def get_mortality_projector(wealth_level: str | None = "average") -> MortalityProjector:
    ...
    wealth_multipliers = {"low": 1.2, "average": 1.0, "high": 0.7}
